...
public class FilterTasksDialog : Dialog
{
    ...
    public FilterTasksDialog()
    {
        ...
        _statusGroup = new RadioGroup(["All", "Incomplete", "Complete"])
        {
            X = 12,
            Y = 1
        };
        ...
        _dueBefore = new TextField("") { X = 12, Y = 4, Width = 15 };

        var lblText = new Label("Contains text:") { X = 1, Y = 6 };
        _textSearch = new TextField("") { X = 12, Y = 6, Width = 30 };
        ...
        _applyButton.Clicked += (_, __) =>
        {
            ...
            {
                case 1: Filter.IsComplete = false; break;
                case 2: Filter.IsComplete = true; break;
            }
        ...
        Add(lblStatus, _statusGroup, lblDue, _dueBefore, lblText, _textSearch, _applyButton, _cancelButton);
    }
}
